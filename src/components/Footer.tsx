      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div className="lg:col-span-2" variants={staggerItem}>
            ...
            <div className="flex space-x-4">
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Facebook logo">
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Instagram logo">
          ...
          <motion.div variants={staggerItem}>
            <h3 className="text-lg font-semibold mb-4 text-mandova">{t('footer.links_title')}</h3>
          ...
          <motion.div variants={staggerItem}>
            <h3 className="text-lg font-semibold mb-4 text-mandova">{t('footer.contacts_title')}</h3>
