...
const NotFoundPage: React.FC = () => {
  ...
  usePageNotFound(`404 - ${t('notfound.title')} | Norvex`);
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "The requested page could not be found on Norvex website.",
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-texts mb-4">
              {t('notfound.title')} <span className="text-mandova">{t('notfound.titleHighlight')}</span>
            </h2>
